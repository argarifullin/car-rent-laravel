            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="post" action="{{route('user.edit.manager')}}">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="pickpoint_id" class="form-control select2 select2-hidden-accessible" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true">
                                            ...
                                            <option name="pickpoint_id" data-select2-id="3" value="{{$pickpoint->id}}" @if ($manager->pickpoint_id == $pickpoint->id) selected @endif> {{$pickpoint->address}}</option>
                                            @endforeach
                                        </select>
